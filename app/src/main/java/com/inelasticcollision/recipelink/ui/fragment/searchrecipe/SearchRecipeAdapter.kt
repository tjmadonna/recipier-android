...
import com.inelasticcollision.recipelink.databinding.ItemSearchRecipeBinding
    ...
    class ViewHolder(
        ...
        fun bindRecipe(recipe: Recipe) {
            ...
            binding.clickContainer.setOnClickListener { view ->
                val direction =
                    SearchRecipeFragmentDirections.actionSearchRecipeFragmentToRecipeDetailFragment(
                        recipe.id
                    )
